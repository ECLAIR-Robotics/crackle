...
#ifndef XARM_MSGS__SRV__DETAIL__MOVE_CIRCLE__FUNCTIONS_H_
#define XARM_MSGS__SRV__DETAIL__MOVE_CIRCLE__FUNCTIONS_H_
 ...
 * calls
 * xarm_msgs__srv__MoveCircle_Request__init().
...
/**
 * It calls
 * xarm_msgs__srv__MoveCircle_Request__fini()
...
/**
 * It calls
 * xarm_msgs__srv__MoveCircle_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * xarm_msgs__srv__MoveCircle_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_xarm_msgs
...
/**
 * It calls
 * xarm_msgs__srv__MoveCircle_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_xarm_msgs
...
/**
 * It calls
 * xarm_msgs__srv__MoveCircle_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // XARM_MSGS__SRV__DETAIL__MOVE_CIRCLE__FUNCTIONS_H_
