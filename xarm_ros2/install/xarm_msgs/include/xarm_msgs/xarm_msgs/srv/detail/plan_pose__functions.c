  ...
  xarm_msgs__srv__PlanPose_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    xarm_msgs__srv__PlanPose_Request * data =
      (xarm_msgs__srv__PlanPose_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!xarm_msgs__srv__PlanPose_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          xarm_msgs__srv__PlanPose_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  xarm_msgs__srv__PlanPose_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    xarm_msgs__srv__PlanPose_Response * data =
      (xarm_msgs__srv__PlanPose_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!xarm_msgs__srv__PlanPose_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          xarm_msgs__srv__PlanPose_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
