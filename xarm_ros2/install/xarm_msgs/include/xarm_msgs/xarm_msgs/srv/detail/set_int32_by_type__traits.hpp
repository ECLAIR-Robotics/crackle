...
inline void to_flow_style_yaml(
  const SetInt32ByType_Request & msg,
  std::ostream & out)
{
  out << "{";
  // member: type
...
inline std::string to_yaml(const SetInt32ByType_Request & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const xarm_msgs::srv::SetInt32ByType_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const xarm_msgs::srv::SetInt32ByType_Request & msg)
{
...
inline void to_flow_style_yaml(
  const SetInt32ByType_Response & msg,
  std::ostream & out)
{
  out << "{";
  // member: ret
...
inline std::string to_yaml(const SetInt32ByType_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use xarm_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const xarm_msgs::srv::SetInt32ByType_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  xarm_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use xarm_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const xarm_msgs::srv::SetInt32ByType_Response & msg)
{
  return xarm_msgs::srv::to_yaml(msg);
}
