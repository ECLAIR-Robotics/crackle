...
#ifndef XARM_MSGS__SRV__DETAIL__ROBOTIQ_ACTIVATE__TYPE_SUPPORT_H_
#define XARM_MSGS__SRV__DETAIL__ROBOTIQ_ACTIVATE__TYPE_SUPPORT_H_
...
#endif  // XARM_MSGS__SRV__DETAIL__ROBOTIQ_ACTIVATE__TYPE_SUPPORT_H_
