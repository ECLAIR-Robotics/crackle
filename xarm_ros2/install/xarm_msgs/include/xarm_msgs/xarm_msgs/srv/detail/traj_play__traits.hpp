  ...
  std::ostream & out)
{
  ...
  {
    out << "double_speed: ";
    rosidl_generator_traits::value_to_yaml(msg.double_speed, out);
    out << ", ";
  }
...
inline std::string to_yaml(const TrajPlay_Request & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const xarm_msgs::srv::TrajPlay_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const xarm_msgs::srv::TrajPlay_Request & msg)
{
...
inline std::string to_yaml(const TrajPlay_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use xarm_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const xarm_msgs::srv::TrajPlay_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  xarm_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use xarm_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const xarm_msgs::srv::TrajPlay_Response & msg)
{
  return xarm_msgs::srv::to_yaml(msg);
}
