...
def cross_correlation(file_name):
    ...
    # plt.figure()
    # plt.plot(left_timestamps, left_read, linestyle=":", label="left")
    # plt.plot(right_timestamps, right_read, label="right")
    # plt.title("data")
...
def get_angle(t):
    ...
    return (90-(180/math.pi)*math.atan(math.sqrt((4*(d**2)-(c*t)**2)/(c*t)**2)))*left_right_multiplier

# print(cross_correlation("Timestamp Corrected/90 Degrees Left/1.csv"))
