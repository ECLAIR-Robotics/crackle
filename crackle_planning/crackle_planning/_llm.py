...
class GptAPI:
    def __init__(self):
        ...
        self._instructions = (
            ...
            "HOLDING FOR THE USER: When the user asks you to hold something for them "
            "(e.g. 'hold this for me', 'can you take this', 'grab this'), call "
            "hold_object_from_user — the arm reaches the hold pose and opens the "
            "gripper to receive the object. Do NOT close it yourself; tell the user to "
            "say 'close gripper' once they've placed it. When they then say 'close "
            "gripper' (or 'close it', 'grab it'), call set_gripper_state('close') to "
            "grasp it.\n\n"
